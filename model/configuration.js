...
export class Configuration {
    ...
    static fromString(config) {
        ...
        var consoles = configurationObject.consoles.map((/** @type {{ name: string; romRoots: string[]; commandLineOptions: string; tags: string[]; }} */ t) => new Console(t.name, t.romRoots, t.commandLineOptions, t.tags))
